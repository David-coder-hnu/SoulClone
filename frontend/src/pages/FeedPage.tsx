    ...
    <AppShell>
      <div className="p-4 md:p-8 max-w-xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-accent-cyan/20 text-accent-cyan text-sm font-medium hover:bg-accent-cyan/30 transition-colors">
            <Plus size={16} />
        ...
        <div className="space-y-6">
          {mockPosts.map((post, i) => (
            ...
            >
              ...
              {/* Content */}
              <p className="text-text-primary leading-relaxed mb-4">{post.content}</p>
